...
KNMI_DATA_DIR = join(TEST_DATA_DIR, "knmi-climate-explorer")
SCRIPT_TO_RUN = join(here, "..", "scripts/crunch_to_scm.py")
INPUT_DIR = join(here, "..", TEST_DATA_DIR, "marble-cmip5/")
OUTPUT_DIR = join(here, "..", "output-examples")
VAR_TO_CRUNCH = "tas"
...
for dirpath, dirnames, filenames in walk(OUTPUT_DIR):
    if not dirnames:
        ...
        knmi_data_path = join(KNMI_DATA_DIR, knmi_data_name)
